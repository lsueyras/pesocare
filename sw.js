const CACHE='bodycare-v16-6';
const CORE=['./','./index.html','./styles.css?v=16.6-bodycare','./app.js?v=16.6-bodycare','./manifest.webmanifest','./icon.svg','./brand-logo.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
