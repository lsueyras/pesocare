const CACHE='bodycare-v24-1';
const CORE=['./','./index.html','./styles.css?v=24.1-bodycare','./app.js?v=24.1-bodycare','./manifest.webmanifest','./icon.svg','./brand-logo.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
