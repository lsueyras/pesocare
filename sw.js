const CACHE='bodycare-v25-1';
const CORE=['./','./index.html','./styles.css?v=25.1-bodycare','./app.js?v=25.1-bodycare','./manifest.webmanifest','./icon.svg','./brand-logo.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
