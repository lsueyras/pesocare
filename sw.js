const CACHE='bodycare-v21-2';
const CORE=['./','./index.html','./styles.css?v=21.2-bodycare','./app.js?v=21.2-bodycare','./manifest.webmanifest','./icon.svg','./brand-logo.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
