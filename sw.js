const CACHE='bodycare-v16-3';
const CORE=['./','./index.html','./styles.css?v=16.3-bodycare','./app.js?v=16.3-bodycare','./manifest.webmanifest','./icon.svg','./brand-logo.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
