const CACHE='bodycare-v19';
const CORE=['./','./index.html','./styles.css?v=19-bodycare','./app.js?v=19-bodycare','./manifest.webmanifest','./icon.svg','./brand-logo.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
