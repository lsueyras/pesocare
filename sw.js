const CACHE='bodycare-v17';
const CORE=['./','./index.html','./styles.css?v=17-bodycare','./app.js?v=17-bodycare','./manifest.webmanifest','./icon.svg','./brand-logo.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
